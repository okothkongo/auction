defmodule AuctionWeb.UserController do
  ...
  defp prevent_unauthorized_access(conn, _opts) do
    ...
    if user_not_in_session?(current_user, requested_user_id) do
      conn
  ...
  defp user_not_in_session?(current_user, requested_user_id) do
    current_user == nil || current_user.id != requested_user_id
  end
end
